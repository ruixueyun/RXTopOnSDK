...
Pod::Spec.new do |s|
  s.name             = 'RXTopOnSDK'
  s.version          = '1.0.1'
  s.summary          = 'ruixue RXTopOnSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXTopOnSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXTopOnSDK.git', :tag => s.version.to_s }
  ...
  s.dependency 'TraminiSDK','6.3.50'
  s.dependency 'TPNiOS','6.3.50'
end
